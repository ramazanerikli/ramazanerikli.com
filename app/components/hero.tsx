        ...
        <div className="lg:w-1/6">
          <div className="h-full flex items-center justify-start">
            <button
              ...
              className="
       inter-medium border border-2 transition-all duration-500 
       text-center transition-all duration-500  
       text-black bg-white hover:bg-black hover:text-white hover:border-black
       rounded-xl text-md px-8 py-2.5 mr-2 mb-2 focus:outline-none"
            >
              Contact
            </button>
          </div>
        ...
        <div className="lg:w-5/6">
          <div className="flex flex-col items-start gap-1 md:flex-row md:gap-16">
            <div className="flex flex-row-reverse items-baseline md:flex-col">
              ...
              <dd className="w-32 text-sm text-text-2 md:w-auto">Experience</dd>
            </div>
            <div className="flex flex-row-reverse items-baseline md:flex-col">
            ...
            <div className="flex flex-row-reverse items-baseline md:flex-col">
              ...
              <dd className="w-32 text-sm text-text-2 md:w-auto">Location</dd>
            </div>
            <div className="flex flex-row-reverse items-baseline md:flex-col">
              <dt className="inter-medium">English & Turkish</dt>
              <dd className="w-32 text-sm text-text-2 md:w-auto">Languages</dd>
            </div>
          </div>
        </div>
      </div>
